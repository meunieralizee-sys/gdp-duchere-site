...
import { MapPin, Phone, Users, Target, Calendar, Heart, Menu, X } from "lucide-react";
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex gap-6">
              <a href="#presentation" className="hover:text-purple-200 transition">Présentation</a>
              <a href="#structures" className="hover:text-purple-200 transition">Structures</a>
              <a href="#actions" className="hover:text-purple-200 transition">Actions</a>
              <a href="#actus" className="hover:text-purple-200 transition">Actus</a>
